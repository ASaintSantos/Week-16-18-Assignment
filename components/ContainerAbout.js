...
function ContainerAbout() {
  return (
    <div>
      ...
      <Row>
        <Col><br></br>
          <h1 style={{marginLeft:"565px"}}>About Us</h1><br></br>
      ...
      <Row>
        <Col>
          <h2 style={{marginLeft:"550px"}}>Our Mission</h2><br></br>
      ...
      <Row>
        <Col>
          <h2 style={{marginLeft:"565px"}}>Our Team</h2><br></br>
      ...
      <Row>
        <Col><br></br>
          <h2 style={{marginLeft:"550px"}}>Contact Us</h2><br></br>
      ...
      <Row>
        <Col><br></br>
          <h2 style={{marginLeft:"550px"}}>Our Church</h2><br></br>
          <p>Visit us at our Church: LIFE CHURCH</p>
          <Image src="https://images.squarespace-cdn.com/content/v1/634c4cf9d612d87a6625af5f/1667100355221-U0KPFOV3VZ0VFD35MNXV/se.jpg" alt="Life Church" style={{marginLeft:"400px", height:"450px", width:"450px"}} fluid />
        </Col>
      </Row>
    </Container>
    </div>
